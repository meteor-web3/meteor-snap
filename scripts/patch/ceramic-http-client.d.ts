...
export declare class CeramicClient implements CeramicApi {
    ...
    loadStream<T extends Stream>(streamId: StreamID | CommitID | string, opts?: LoadOpts, custom?: Custom): Promise<T>;
    ...
    buildDocumentFromState<T extends Document = Document>(state: StreamState): T;
