...
(function(globalThis) {
	(function (factory) {
		...
		var BlobBuilder = globalThis.BlobBuilder
			|| globalThis.WebKitBlobBuilder
			|| globalThis.MSBlobBuilder
			|| globalThis.MozBlobBuilder;

		var URL = globalThis.URL || globalThis.webkitURL || function (href, a) {
		...
		var strTag = globalThis.Symbol && globalThis.Symbol.toStringTag;
		...
		function stringEncode (string) {
			...
			var Arr = globalThis.Uint8Array || Array; // Use byte array when possible
		...
		function FakeBlobBuilder () {
			...
			function isDataView (o) {
				return getObjectTypeName(o) === "DataView" || isPrototypeOf(globalThis.DataView, o);
			}
			...
			function isArrayBuffer(o) {
				return includes(arrayBufferClassNames, getObjectTypeName(o)) || isPrototypeOf(globalThis.ArrayBuffer, o);
			}
			...
			function Blob (chunks, opts) {
				...
				this._buffer = globalThis.Uint8Array
			...
			Blob.prototype.toString = function () {
				// return "[object Blob]";
				var data = textDecode(this._buffer);
				console.log("Blob.prototype.toString", this, data);
				return data;
			};
			...
			File.prototype.toString = function () {
				// return "[object File]";
				var data = textDecode(this._buffer);
				console.log("File.prototype.toString", this, data);
				return data;
			};
			...
			function FileReader () {
				...
				this.removeEventListener = emitter.off;
			}
			...
			function _read (fr, blob, kind) {
				...
				console.log("Blob.polyfill._read", { fr, blob, kind });
			}
			...
			// /*                         XHR                          */
			// /********************************************************/
			// var _send = globalThis.XMLHttpRequest && globalThis.XMLHttpRequest.prototype.send;
			// if (_send) {
		...
		function fixFileAndXHR () {
			// var isIE = !!globalThis.ActiveXObject || (
			...
			try {
				...
				exports.FileReader = globalThis.FileReader;
			} catch (e) {
				try {
		...
		if (blobSupported) {
			fixFileAndXHR();
			exports.Blob = blobSupportsArrayBufferView ? globalThis.Blob : BlobConstructor;
